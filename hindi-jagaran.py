...
class JagaranCrawler(MultiThreadedCrawler2):
    ...
    def process_page(self, url, soup):
        ...
        content = soup.find(class_='detailBox')
...
if __name__ == '__main__':
    crawler = JagaranCrawler('jagaran.com', num_threads=12)
